...
void leftQual(){
  ...
  chassis.pid_turn_set(get_heading(-23.8, 21.729, -12.28, 9.194) + 180, 115); //turn back to mid goal
  pros::delay(600);

  chassis.pid_drive_set(-1 * (get_distance(-23.8, 21.729, -12.28, 9.194)), 65); //drive into mid goal backwards
  stopIntake();
  pros::delay(600);
  ...
  chassis.pid_drive_set(37, 85); //drive to set up wing
  pros::delay(1000);
  ...
  chassis.pid_drive_set(23, 127); //drive forward and descore
...
void rightQual(){
  ...
  chassis.pid_drive_set(9, 127); //drive to alley lane
  chassis.pid_wait();
...
void skills(){
 ...
 //intake balls
  ...
  pros::delay(500);
  chassis.pid_drive_set(14.2, 70); //drive into matchload
  fullIntake();
  pros::delay(600);
  pros::delay(1500);
  ...
  pros::delay(500);
  chassis.pid_drive_set(-(get_distance(22.785,-23.015,8,-8)+2), 100); // drive into mid, added 2
  chassis.pid_wait();
  ...
  chassis.pid_drive_set(get_distance(43, -41, 54, -41), 65); //drive into matchload while intaking
  fullIntake();
  pros::delay(2700);  
